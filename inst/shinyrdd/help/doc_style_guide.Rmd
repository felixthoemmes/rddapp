...
* Bold terms that are direct references to objects in the app interface (e.g. the **Data** panel, not the **Data panel**). Only bold the keyword (e.g. Data, Browse, gear), not the descriptor (e.g. panel, button, menu).
