...
## Table 5.1 Powers of RDD estimates
...
* **S**: the number of successful Monte Carlo simulations; typically, this value will be equal to the number of iterations, but for some unsual models (e.g., lots of fuzzyiness in the assignment), it is possible that some simulations do not yield a valid estimate;
...
## Figure 5.1 Power by Sample Size
...
Both the currently displayed plot and the full simulation data can be downloaded using the buttons in the top right corner of the Figure 5.1 panel. The plot can be downloaded as a `.png`, `.svg`, or `.pdf`. The simluation data can be downloaded as a `.csv` file.
