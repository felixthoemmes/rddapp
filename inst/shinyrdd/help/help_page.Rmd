...
Once the assignment is specified, the user must specify the **parametric model** for the **outcome** variable as a function of the assignement and treatment.
...
* the two treatment effects (labeled **T1** and **T2** for **A1** And **A2** respectively), which set the effect size of the treatment at the threshold of each assignment variable;

<!-- IP: STOPPED EDITING HERE -->

* the two regression coefficients that relate the assignment variables to the outcome (while holding treatments constant at the control group).
