...
<!-- IP: STARTED EDITING HERE. -->

# Sensitivities tab {#sensitivities_tab}
In this tab, the user can perform various **sensitivity analyses**, including those for the **treatment threshold** and the **bandwidth parameter**. Note that neither of figures 4.1 or 4.2 will be generated automatically; they will only appear after the blue circular arrow button is pressed (found in the lower right corner of each figure panel).
