...
where $|u|\leq 1$, except for with the Gaussian kernel, where $u$ can be any real number. In line with recommendations of Imbens and Kalyanaraman (XXXX), we recommend the use of the triangular kernel.
