...
Formally, this is the $l_1$-metric to the frontier, where the distance between a point $p = (p_x,p_y)$ and a set, $A$, is abstractly defined as\footnote{Really, this quantitiy should be phrased in terms of the \href{https://en.wikipedia.org/wiki/Infimum_and_supremum}{infimum} instead of the minimum, but I'm omitting these mathematical details here.}
\begin{align}
