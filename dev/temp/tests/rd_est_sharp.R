...
rddapp_model <- rddapp::RDestimate(y ~ x, cutpoint = 0)
...
rddapp_model <- rddapp::RDestimate(y ~ x, cutpoint = 0.1)
...
rddapp_model <- rddapp::RDestimate(y ~ x, bw = 0.8)
...
rddapp_model <- rddapp::RDestimate(y ~ x, cutpoint = 0, se.type = "const")
...
rddapp_model <- rddapp::RDestimate(y ~ x, cutpoint = 0, se.type = "HC1")
data_model <- rddtools::rdd_data(x = x, y = y, cutpoint = 0)
rddtools_model <- rddtools::rdd_reg_lm(data_model, slope = "separate")
rddtools_test <- lmtest::coeftest(rddtools_model, 
...
rddapp_model <- rddapp::RDestimate(y ~ x, cutpoint = 0.1, se.type = "HC0")
...
data_rdd <- rdd_data(x = x, y = y, cutpoint = 0)
