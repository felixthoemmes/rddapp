rddapp
==================================================
[![Travis-CI Build Status](https://travis-ci.org/felixthoemmes/rddapp)](https://travis-ci.org/felixthoemmes/rddapp.svg?branch=master) [![Downloads](http://cranlogs.r-pkg.org/badges/rddapp)](http://cran.rstudio.com/web/packages/rddapp/index.html) [![Cran Build](https://www.r-pkg.org/badges/version/rddapp)](https://cran.r-project.org/web/packages/rddapp/index.html)
